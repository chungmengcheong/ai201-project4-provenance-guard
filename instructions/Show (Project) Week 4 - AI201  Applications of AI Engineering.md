---
title: "Show (Project): Week 4 - AI201 | Applications of AI Engineering"
source: "https://courses.codepath.org/courses/ai201/unit/4#!projects"
author:
published:
created: 2026-06-25
description:
...
> [!info] Info
> 📬 Reminder: Project 4 is due by **Sunday, June 28th at 11:59PM PDT**.
...
> ### 🗺️ How It's Graded
> 
> *A detailed breakdown of graded features and points can be found on the course [grading](https://courses.codepath.org/courses/ai201/pages/grading#heading-project-4-provenance-guard) page — **29 points total (25 required + 4 stretch)**. Read it before you start.*
...
- Build confidence scoring that communicates uncertainty rather than forcing binary Output.
...
- Create `planning.md` in your repo root. Design the structure yourself. At minimum, your document must address these five questions with specific, implementation-ready answers:
	...
	- **Uncertainty representation:** What does a confidence score of 0.6 mean to your system? How will you map raw signal Output to a calibrated score? What threshold separates "likely AI" from "uncertain" from "likely human"?
...
> 
> New to Flask? Start with the [Flask Quickstart](https://courses.codepath.org/courses/ai201/pages/flask_quickstart.md) — a 20-minute primer covering a minimal POST/GET app, `jsonify`, Flask-Limiter setup, and a simple log helper.
...
- [RepairSafe lab starter (Lab 4)](https://github.com/codepath/ai201-lab4-repairsafe-starter): The Week 4 lab repo — a worked example of an AI classification + safety-label backend in the same problem space as this project
- [AI Prompting Guide](https://courses.codepath.org/courses/ai201/pages/ai_prompting_guide.md): Patterns for directing AI tools to debug, design, and refine your code
- [Flask Quickstart](https://courses.codepath.org/courses/ai201/pages/flask_quickstart.md): A 20-minute primer on a minimal POST/GET Flask app, `jsonify`, Flask-Limiter setup, and a simple log helper
- [Study Hall](https://courses.codepath.org/courses/ai201/pages/recordings.md): Bring your architecture sketch and questions — don't struggle alone (see the Study Hall schedule and recordings)